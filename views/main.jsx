...
export default class Main extends React.Component {
  ...
  componentWillMount(){
    ...
    menu.append(new MenuItem({label: 'About Price Point++', click() { main.open('https://ppyazi.com/pricepoint') }}))
  ...
  render() {
    ...
    <h2><a onClick={() => this.handleOpen('https://ppyazi.com/pricepoint')}>Price Point++  </a> 
